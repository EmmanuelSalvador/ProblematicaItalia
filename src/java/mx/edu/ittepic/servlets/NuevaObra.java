 ...
 * @author DELL
 */
@WebServlet(name = "NuevaObra", urlPatterns = {"/NuevaObra"})
public class NuevaObra extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NuevaObra</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NuevaObra at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        p.write(ejb.nuevoObra(nombre_obra, Integer.parseInt(anio_creacion), Integer.parseInt(fk_id_artista), descripcion_corta, descripcion_larga, Float.parseFloat(valoracion),Integer.parseInt(cantidad_visitas), Integer.parseInt(fk_id_seccion)));
    }
