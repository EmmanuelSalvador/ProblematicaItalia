 ...
 * @author DELL
 */
@WebServlet(name = "NuevoMuseo", urlPatterns = {"/NuevoMuseo"})
public class NuevoMuseo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NuevoMuseo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NuevoMuseo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        p.write(ejb.nuevoMuseo(nombre_museo, ciudad_museo, direccion_museo, descripcion_corta, descripcion_larga, Integer.parseInt(cantidad_visitas), fk_id_seccion));
    }
